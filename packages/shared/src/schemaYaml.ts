 ...
 *
 * ```ts
 * import { parseYaml } from "@lecturn/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@lecturn/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@lecturn/shared/schemaYaml"
 *
