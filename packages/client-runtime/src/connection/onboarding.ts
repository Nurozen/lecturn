import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@lecturn/contracts";
import { resolveRemotePairingTarget } from "@lecturn/shared/remote";
...
>()("@lecturn/client-runtime/connection/onboarding/ConnectionOnboarding") {}
