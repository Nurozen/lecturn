...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set LECTURN_BITBUCKET_EMAIL and LECTURN_BITBUCKET_API_TOKEN, or LECTURN_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check LECTURN_BITBUCKET_EMAIL and LECTURN_BITBUCKET_API_TOKEN.",
  },
};
