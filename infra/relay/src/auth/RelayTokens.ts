...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@lecturn/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "lecturn-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "lecturn-relay-dpop-access+jwt";
...
>()("lecturn-relay/auth/RelayTokens") {}
