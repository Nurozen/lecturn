import type { RelayDeviceRegistrationRequest } from "@lecturn/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.cloudgatherer.lecturn.preview" as RelayDeviceRegistrationRequest["bundleId"],
