...
Every adapter uses `apps/server/src/provider/RuntimeInstructions.ts` to identify Lecturn and
...
print it on stdout. Lecturn accepts the exact native prefix on either stream and its browser-helper
