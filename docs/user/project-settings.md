...
Lecturn supports SVG, PNG, ICO, JPEG, GIF, AVIF, and WebP files. The selected path applies to
...
Lecturn checks in the background and when the server starts. It uses the branch's configured
