...
>()("lecturn/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* LecturnProjectFileLoader.LecturnProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A lecturn.json iconPath takes precedence over the well-known locations.
