...
import { isDevProxiedPath } from "@lecturn/shared/devProxy";
import { decodeOtlpTraceRecords } from "@lecturn/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["lecturn://app", "lecturn-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // LECTURN_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
