import type { ServerSelfUpdateOutcome } from "@lecturn/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different lecturn version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "lecturn/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("lecturn/cloud/serviceLauncherClient") {}
