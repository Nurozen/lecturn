...
declare const __LECTURN_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __LECTURN_BUILD_CHANNEL__ === "undefined" ? "dev" : __LECTURN_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Lecturn (Dev)",
  nightly: "Lecturn (Nightly)",
  latest: "Lecturn",
...
<html lang="en">
  <head>
    ...
    <title>Lecturn Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Lecturn Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
