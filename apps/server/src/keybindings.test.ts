import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@lecturn/contracts";
...
import { KeybindingsConfigError } from "@lecturn/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "lecturn-keybindings-test-",
        }),
      ),
    ),
  );
