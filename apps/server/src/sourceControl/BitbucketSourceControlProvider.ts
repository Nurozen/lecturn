...
import { SourceControlProviderError, type ChangeRequest } from "@lecturn/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set LECTURN_BITBUCKET_EMAIL and LECTURN_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
