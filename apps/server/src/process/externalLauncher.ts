...
// per-command cache lookups in @lecturn/shared/shell.
//
...
// command-resolution cache in @lecturn/shared/shell, so a backward wall-clock
...
>()("lecturn/process/externalLauncher") {}
