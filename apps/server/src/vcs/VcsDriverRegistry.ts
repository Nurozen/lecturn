...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@lecturn/contracts";
import { VcsUnsupportedOperationError } from "@lecturn/contracts";
