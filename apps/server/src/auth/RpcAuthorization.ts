...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.previewCheckpointRevert]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.cloudCreateManualLinkProof]: AuthRelayWriteScope,
  [WS_METHODS.cloudApplyManualRelayConfig]: AuthRelayWriteScope,
  [WS_METHODS.cloudGetRelayClientStatus]: AuthRelayReadScope,
  [WS_METHODS.cloudInstallRelayClient]: AuthRelayWriteScope,
  [WS_METHODS.sagaWorkbenchGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.sagaWorkbenchGetEvidence]: AuthOrchestrationReadScope,
  [WS_METHODS.sagaWorkbenchGetActivity]: AuthOrchestrationReadScope,
  [WS_METHODS.sagaWorkbenchSetStage]: AuthOrchestrationOperateScope,
  [WS_METHODS.sagaWorkbenchConfigure]: AuthOrchestrationOperateScope,
  [WS_METHODS.sagaWorkbenchApprove]: AuthOrchestrationOperateScope,
  [WS_METHODS.sagaWorkbenchComplete]: AuthOrchestrationOperateScope,
  [WS_METHODS.sagaWorkbenchReopen]: AuthOrchestrationOperateScope,
  [WS_METHODS.sagaWorkbenchSummarize]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.threadDecisionsFunding]: AuthRelayWriteScope,
  [WS_METHODS.threadDecisionsFundingStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadDecisionsSettings]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadDecisionsStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsSourceWindow]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsScan]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadDecisionsExport]: AuthOrchestrationReadScope,
  [WS_METHODS.threadDecisionsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.threadNotesList]: AuthOrchestrationReadScope,
  [WS_METHODS.threadNotesCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadNotesUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadNotesDelete]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.externalSessionsList]: AuthOrchestrationReadScope,
