...
>()("lecturn/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Lecturn could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Lecturn still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
