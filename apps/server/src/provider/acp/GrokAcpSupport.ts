import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@lecturn/contracts";
...
const LECTURN_OAUTH_REFERRER = "lecturn";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: LECTURN_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Lecturn's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
