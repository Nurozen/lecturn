import { tokenizeCliArgs } from "@lecturn/shared/cliArgs";

export const LECTURN_CODEX_LAUNCH_ARGS_ENV = "LECTURN_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[LECTURN_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
