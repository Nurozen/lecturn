...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@lecturn/contracts";
...
const owner = "lecturn-auth-session-owner";
const otherOwner = "lecturn-auth-session-other";
