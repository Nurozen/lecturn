...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allLecturn.currentCpuPercent,
      rssBytes: merged.groups.allLecturn.currentRssBytes,
      processCount: merged.groups.allLecturn.processCount,
