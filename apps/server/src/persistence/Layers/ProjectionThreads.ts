    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.importedFrom === undefined || row.importedFrom === null ? null : JSON.stringify(row.importedFrom)},
          ${row.importSource === undefined || row.importSource === null ? null : JSON.stringify(row.importSource)},
          ${row.latestTurnId},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.archivedAt},
        ...
        DO UPDATE SET
          ...
          import_source_json = excluded.import_source_json,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          import_source_json AS "importSource",
