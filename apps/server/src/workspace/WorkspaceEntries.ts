...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@lecturn/shared/path";
import { normalizeSearchQuery } from "@lecturn/shared/searchRanking";
...
>()("lecturn/workspace/WorkspaceEntries") {}
