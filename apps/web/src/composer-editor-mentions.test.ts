import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@lecturn/contracts";
...
describe("splitPromptIntoComposerSegments", () => {
  ...
  it("keeps malformed citation links as editable text", () => {
    const prompt =
      "[Assistant quote](lecturn-citation://v1/env/thread/message?text=missing+metadata)";
