import type { EnvironmentTheme } from "@lecturn/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent Lecturn palette rather than a foreign
 ...
 * than rendered: a published `lecturn-iris.json` would show this palette on its
