...
} from "@lecturn/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "lecturn.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "lecturn.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "lecturn.renderBrowserFile";
