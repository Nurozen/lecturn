  ...
  return (
    <div className="grid gap-3">
      <div className="grid gap-2">
        ...
        {usesCustomBinary ? (
          <p className="text-muted-foreground">
            Clear the binary path below to install or remove the managed runtime.
          </p>
        ) : null}
        ...
        <div className="flex flex-wrap gap-2">
          {installActive && installation.operationId ? (
            ...
            <Button
              size="xs"
              variant="outline"
              disabled={actionsDisabled || installation === null || authActive || usesCustomBinary}
          ...
          {installation?.canRemove && !installActive ? (
            <Button
              size="xs"
              variant="ghost"
              disabled={actionsDisabled || authActive || usesCustomBinary}
