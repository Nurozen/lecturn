  ...
  switch (operation.kind) {
    case "lifecycleAction":
      ...
      return operation.action === "archiveNow" || operation.target === "archive"
        ? "This stops sessions and archives the space. A saga member leaves its saga first. Specs, notes, memories and committed branches survive. Restore it from New project → Stave."
    ...
    case "archiveSpace":
      return "This stops sessions, removes worktrees, and moves the space into the archive. A saga member leaves its saga first, dropping other members' ordering edges to it. Its manifest, spec, notes, and committed branches survive. Restore it from New project → Stave.";
    case "sagaDestroy":
    ...
    case "sagaArchive":
      return "This stops sessions and archives the saga and every live member in reverse dependency order. Specs, notes and committed branches survive. A refusal can leave earlier members already archived. Restore it from New project → Stave.";
    case "sagaRemove":
