...
const NO_FILE_SCRIPTS: ReadonlyArray<LecturnProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in lecturn.json, offered for import. */
  fileScripts?: ReadonlyArray<LecturnProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: LecturnProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From lecturn.json</MenuGroupLabel>
