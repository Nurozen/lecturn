  ...
  return (
    <div
      ...
      className={cn(
        ...
        "dark:[html[data-theme-id]:not([data-theme-id=lecturn-chat])_&]:[--chat-composer-highlight:color-mix(in_srgb,var(--app-theme-input)_12%,transparent)] dark:[html[data-theme-id]:not([data-theme-id=lecturn-chat])_&]:[--chat-composer-outline:color-mix(in_srgb,var(--app-theme-input)_30%,var(--background))]",
        "dark:[html[data-theme-id=lecturn-chat]_&]:[--chat-composer-highlight:color-mix(in_srgb,#432d48_12%,transparent)] dark:[html[data-theme-id=lecturn-chat]_&]:[--chat-composer-outline:#241e28]",
