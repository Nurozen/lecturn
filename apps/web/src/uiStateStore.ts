...
export const PERSISTED_STATE_KEY = "lecturn:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "lecturn:renderer-state:v8",
  "lecturn:renderer-state:v7",
  "lecturn:renderer-state:v6",
  "lecturn:renderer-state:v5",
  "lecturn:renderer-state:v4",
  "lecturn:renderer-state:v3",
