...
import type { DesktopPreviewFavicon, ScopedProjectRef, ScopedThreadRef } from "@lecturn/contracts";
...
const BROWSER_FAVICON_STORAGE_KEY = "lecturn:browser-favicons:v1";
