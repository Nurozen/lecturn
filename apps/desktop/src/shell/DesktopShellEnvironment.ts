...
>()("@lecturn/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__LECTURN_ENV_${name}_START__`;
const endMarker = (name: string) => `__LECTURN_ENV_${name}_END__`;
