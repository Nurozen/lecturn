import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@lecturn/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@lecturn/shared/observability";
...
>()("@lecturn/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
