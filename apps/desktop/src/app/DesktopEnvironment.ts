...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly userDataPathOverride?: string;
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.cloudgatherer.lecturn.dev" : "com.cloudgatherer.lecturn",
    ),
    linuxDesktopEntryName: isDevelopment ? "lecturn-dev.desktop" : "lecturn.desktop",
    linuxWmClass: isDevelopment ? "lecturn-dev" : "lecturn",
