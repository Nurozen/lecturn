 ...
 * into a Lecturn browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@lecturn/contracts";
...
>()("@lecturn/desktop/preview/BrowserImport/BrowserImport") {}
