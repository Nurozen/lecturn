import type { DesktopSshPasswordPromptRequest } from "@lecturn/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@lecturn/contracts";
import type { SshPasswordRequest } from "@lecturn/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Lecturn window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@lecturn/desktop/ssh/DesktopSshPasswordPrompts") {}
