...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "lecturn-composer-paste"
...
public final class LecturnComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
