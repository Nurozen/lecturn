package expo.modules.lecturnnativecontrols
...
class LecturnKeyboardCommandsModule : Module() {
  override fun definition() = ModuleDefinition {
    Name("LecturnKeyboardCommands")

    View(LecturnKeyboardCommandsView::class) {
      Prop("enabledCommands") { view: LecturnKeyboardCommandsView, commands: List<String> ->
...
class LecturnKeyboardCommandsView(
  context: Context,
