...
import { installMarkdownCopySanitizer } from "./LecturnMarkdownTextSelectionModule";
...
export function NativeMarkdownSelectableText(props: {
  ...
  // LecturnMarkdownText only rebuilds its attributed string during native layout. A
        ...
        return (
          <MarkdownTextPrimitive
            ...
            nativeID={
              Platform.OS === "ios"
                ? run.fileIcon
                  ? `lecturn-file:${Image.resolveAssetSource(markdownFileIconSource(run.fileIcon)).uri}`
                  : run.skillName
                    ? "lecturn-skill:sf:cube"
                    : undefined
                : undefined
            }
