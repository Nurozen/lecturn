...
import LecturnMarkdownTextRunNativeComponent from "./LecturnMarkdownTextRunNativeComponent";
import LecturnMarkdownTextNativeComponent from "./LecturnMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <LecturnMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <LecturnMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
