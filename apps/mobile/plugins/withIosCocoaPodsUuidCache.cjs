...
const MARKER = "# lecturn: repair cached CocoaPods UUID allocation before SPM integration";
const UUID_REPAIR = `${MARKER}
    ...
    Pod::UI.puts "Lecturn: reset CocoaPods UUID allocator at #{next_index} (#{existing_uuids.length} existing objects)"
`;
