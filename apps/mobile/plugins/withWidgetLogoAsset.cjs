...
// Ships the Lecturn mark to the Live Activity / widget extension.
//
...
const IMAGE_SET = "LecturnMark.imageset";
const SVG_NAME = "LecturnMark.svg";
...
function withAssetFiles(config) {
  return withDangerousMod(config, [
    "ios",
    (cfg) => {
      const source = path.resolve(cfg.modRequest.projectRoot, "../../assets/lecturn/mark.svg");
