import type { EnvironmentRpcSubscriptionObservation } from "@lecturn/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@lecturn/contracts";
