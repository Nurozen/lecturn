...
import type { EnvironmentPresentation } from "@lecturn/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@lecturn/client-runtime/state/presentation";
