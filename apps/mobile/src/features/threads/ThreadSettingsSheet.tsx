    ...
    >
      <View className="min-w-0 flex-1">
        <View className="flex-row items-center gap-2">
          <Text
            className="min-w-0 shrink text-base font-lecturn-medium text-foreground"
            numberOfLines={1}
          >
            {props.option.label}
          </Text>
          {props.option.isDefault ? (
            <View className="rounded-md bg-subtle-strong px-1.5 py-0.5">
              <Text className="text-3xs font-lecturn-bold text-foreground-muted">Default</Text>
            </View>
          ) : null}
          {props.option.isLegacy ? (
            <View className="rounded-md bg-subtle px-1.5 py-0.5">
              <Text className="text-3xs font-lecturn-bold text-foreground-muted">Legacy</Text>
            </View>
          ) : null}
...
function ProviderHeader(props: {
  ...
  const content = (
    <>
      ...
      <Text className="text-sm font-lecturn-medium text-foreground-muted">{props.label}</Text>
      {props.collapsible ? (
        <>
...
function DisclosureRow(props: {
  ...
  return (
    ...
    >
      <Text className="text-sm font-lecturn-medium text-foreground">{props.label}</Text>
      <View className="flex-1" />
      {props.value ? (
  ...
  return (
    ...
    >
      <View className="min-w-0 flex-1 gap-0.5">
        <Text className="text-base font-lecturn-medium text-foreground">{props.label}</Text>
        {props.description ? (
