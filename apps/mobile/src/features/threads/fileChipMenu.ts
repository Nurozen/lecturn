import { resolveMarkdownLinkPresentation } from "@lecturn/mobile-markdown-text/links";
import type { MarkdownFileContextMenu } from "@lecturn/mobile-markdown-text/types";
