  ...
  return (
    ...
    >
      <SymbolView
        ...
        type="monochrome"
      />
      <Text className="font-lecturn-medium text-xs text-foreground">Compacting…</Text>
    </View>
  );
}
  ...
  if (props.status.kind === "syncing") {
    return (
      ...
      >
        ...
        <Text className="font-lecturn-medium text-xs text-foreground">{props.status.label}</Text>
      </View>
    );
  }
