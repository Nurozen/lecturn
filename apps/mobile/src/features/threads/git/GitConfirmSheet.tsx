import { resolveDefaultBranchActionDialogCopy } from "@lecturn/client-runtime/state/vcs";
import { resolveAutoFeatureBranchName } from "@lecturn/shared/git";
...
export function GitConfirmSheet(props: GitConfirmSheetProps) {
  ...
  return (
    <View collapsable={false} className="flex-1 bg-sheet">
      {params.repoKey ? (
        <Text className="px-5 pt-3 text-sm font-lecturn-bold">
      ...
      <View className="items-center gap-1 px-5 pb-3 pt-4">
        ...
        <Text className="text-center text-3xl font-lecturn-bold">
