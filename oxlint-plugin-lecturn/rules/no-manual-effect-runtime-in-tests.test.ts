...
const rule = createOxlintRuleHarness("lecturn/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("lecturn/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("lecturn/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("lecturn/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("lecturn/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
