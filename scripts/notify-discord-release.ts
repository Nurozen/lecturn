  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Lecturn prerelease is available for nightly testers."
          : "A new Lecturn latest release is available.",
...
).pipe(Command.withDescription("Post a Lecturn release announcement to Discord."));
