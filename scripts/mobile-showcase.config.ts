...
export function resolveShowcaseAndroidAbi(
  ...
  throw new Error(
    `Unsupported LECTURN_SHOWCASE_ANDROID_ABI '${value}'. Use ${ANDROID_ABIS.join(", ")}.`,
  );
}
...
const config: ShowcaseConfig = {
  ...
  devices: [
    ...
    },
    {
      id: "iphone-6.5",
      platform: "ios",
      simulator: "Lecturn Showcase iPhone 14 Plus",
    ...
    },
    {
      ...
      abi: resolveShowcaseAndroidAbi(process.env.LECTURN_SHOWCASE_ANDROID_ABI),
      appearance: "dark",
      theme: DEFAULT_SHOWCASE_THEME,
      viewport: {
        width: 1080,
