...
NodeFS.writeFileSync(new URL("claudeAgent.svg", target), svg);
NodeFS.writeFileSync(new URL("apps/marketing/public/harnesses/claude-ai-icon.svg", root), svg);
...
const sprite = NodeFS.readFileSync(spriteFile, "utf8");
...
NodeFS.writeFileSync(spriteFile, updated);
