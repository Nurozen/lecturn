...
const workspaceFiles = [
  ...
  "apps/mobile/modules/lecturn-markdown-text/package.json",
  "apps/mobile/modules/lecturn-review-diff/package.json",
  "apps/mobile/modules/lecturn-terminal/package.json",
  "apps/marketing/package.json",
  "infra/relay/package.json",
  "oxlint-plugin-lecturn/package.json",
...
files:
  - url: Lecturn-Code-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Lecturn-Code-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Lecturn-Code-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Lecturn-Code-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Lecturn-Code-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Lecturn-Code-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
function writeWindowsManifestFixtures(
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Lecturn-Code-9.9.9-smoke.0-arm64.exe
    sha512: arm64exe
    size: 126621344
  - url: Lecturn-Code-9.9.9-smoke.0-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 152344
path: Lecturn-Code-9.9.9-smoke.0-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-08T10:32:14.587Z'
`,
  );
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Lecturn-Code-9.9.9-smoke.0-x64.exe
    sha512: x64exe
    size: 132000112
  - url: Lecturn-Code-9.9.9-smoke.0-x64.exe.blockmap
    sha512: x64blockmap
    size: 160112
path: Lecturn-Code-9.9.9-smoke.0-x64.exe
sha512: x64exe
releaseDate: '2026-03-08T10:36:07.540Z'
`,
  );
...
const tempRoot = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "lecturn-release-smoke-"));
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=Lecturn Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "Lecturn-Code-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "Lecturn-Code-9.9.9-smoke.0-x64.zip",
  ...
  assertContains(
    ...
    "Lecturn-Code-9.9.9-smoke.0-arm64.exe",
    "Merged Windows manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedWindowsManifest,
    "Lecturn-Code-9.9.9-smoke.0-x64.exe",
